  ...
  return (
    <header className="p-6 flex justify-between items-center bg-teal-500 dark:bg-[#17313c]">
      <div className="flex items-center gap-4">
        <img src="/img/image2.jpg" alt="Profile" className="w-16 h-16 rounded-full border-2 border-white dark:border-black" />
        <div>
          <h1 className="text-2xl font-bold">Sina Sasanpour </h1>
          <p className="text-sm">Junior Developer | Assossiate Degree from UÜ</p>
          <div className="flex gap-3 mt-1">
            <a href="https://github.com/RealSinaSnp" target="_blank" rel="noopener noreferrer" className="text-white hover:text-gray-200">
            <FontAwesomeIcon icon={faGithub} size={18}  color={dark ? "white": "black"} />
            </a>
            ...
            <FontAwesomeIcon icon={faLinkedin} size={18}  color={dark ? "white": "black"} />
            </a>
            <a href="https://x.com/RealSinaSNP" target="_blank" rel="noopener noreferrer" className="text-white hover:text-gray-200">
              <FontAwesomeIcon icon={faXTwitter} size={18}  color={dark ? "white": "black"} />
            </a>
