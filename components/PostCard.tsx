      ...
      <div className="flex flex-col gap-6 md:gap-12 xl:flex-row flex-1 order-2 md:order-1">
        <div className="flex flex-col gap-2 border-2 border-green-500">
          <p className="text-xs text-muted-foreground font-mono">{formattedDate}</p>
            <div className="flex flex-row mt-auto items-center justify-between gap-3 border-2 border-sky-500 hidden md:inline">
        ...
        <div className="flex-1 flex flex-col space-y-6  border-2 border-green-500">
          <div className="space-y-4 flex-1 border-2 border-red-500">
            <a href={`/blog/${post.slug}`} className="group" target="_blank" rel="noopener noreferrer">
