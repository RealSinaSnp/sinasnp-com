  ...
  return (
    <>
      <header
        ...
        <div className={`pt-30 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 items-center px-8 py-12 `} >
          ...
          <div className="flex flex-col  items-center lg:items-end md:items-end justify-center order-1 pb-10 md:order-2">
            <img
              src="/img/profile.jpg"
              className="w-44 h-44 rounded-full shadow-lg border-4 border-teal-500"
            />
